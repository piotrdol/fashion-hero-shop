...
export function FilterBar({
  ...
  function handleGenderChange(gender: GenderFilter) {
    ...
    posthog.capture("product_filter_applied", { filter_type: "gender", value: gender });
  }
  ...
  function handleSortChange(sort: SortOption) {
    ...
    onSortChange(sort);
    setSortOpen(false);
    posthog.capture("product_sort_changed", { sort_option: sort });
  }
  ...
  function handlePriceRangeChange(range: PriceRange) {
    ...
    posthog.capture("product_filter_applied", { filter_type: "price_range", value: next });
  }
  ...
  function toggleShoeType(type: ShoeType) {
    ...
    posthog.capture("product_filter_applied", { filter_type: "shoe_type", value: type, active_types: next });
  }
  ...
  function toggleMaterial(material: ShoeMaterial) {
    ...
    posthog.capture("product_filter_applied", { filter_type: "material", value: material, active_materials: next });
  }
